...
@Results({
       ...
       @Result(property = "defaultType", column = "default_type", javaType = java.lang.Byte.class, jdbcType = JdbcType.TINYINT),
...
*/
public final class MetaConfigGroup {

    /**
     * 分组
     */
    public static final String TABLE_NAME = "`rcc_config_group`";
    ...
    public static final String COLUMN_NAME_DEFAULTTYPE = "`default_type`";

    public static final String JAVA_TYPE_DEFAULTTYPE = "java.lang.Byte";

    public static final String JDBC_TYPE_DEFAULTTYPE = "TINYINT";

    public static final String IS_KEY_DEFAULTTYPE = "false";
    ...
    public static String getFieldNameByColumn(String columnName) {
        ...
        if (columnName.equals(COLUMN_NAME_DEFAULTTYPE)) {
            return DEFAULTTYPE;
        }
    ...
    public static String getSafeColumnNameByField(String fieldName) {
        ...
        if (fieldName.equals(DEFAULTTYPE)) {
            return COLUMN_NAME_DEFAULTTYPE;
        }
    ...
    public static String getColumnNameByField(String fieldName) {
        ...
        if (fieldName.equals(DEFAULTTYPE)) {
            return COLUMN_NAME_DEFAULTTYPE.replace("`", "");
        }
        if (fieldName.equals(DELETED)) {
