...
@Results({
       ...
       @Result(property = "priType", column = "pri_type", javaType = java.lang.Byte.class, jdbcType = JdbcType.TINYINT),
...
*/
public final class MetaEnvironmentUser {

    /**
     * 环境用户关系
     */
    public static final String TABLE_NAME = "`rcc_environment_user`";
    ...
    public static final String COLUMN_NAME_PRITYPE = "`pri_type`";

    public static final String JAVA_TYPE_PRITYPE = "java.lang.Byte";

    public static final String JDBC_TYPE_PRITYPE = "TINYINT";

    public static final String IS_KEY_PRITYPE = "false";
    ...
    public static String getFieldNameByColumn(String columnName) {
        ...
        if (columnName.equals(COLUMN_NAME_PRITYPE)) {
            return PRITYPE;
        }
    ...
    public static String getSafeColumnNameByField(String fieldName) {
        ...
        if (fieldName.equals(PRITYPE)) {
            return COLUMN_NAME_PRITYPE;
        }
    ...
    public static String getColumnNameByField(String fieldName) {
        ...
        if (fieldName.equals(PRITYPE)) {
            return COLUMN_NAME_PRITYPE.replace("`", "");
        }
        if (fieldName.equals(UPDATETIME)) {
