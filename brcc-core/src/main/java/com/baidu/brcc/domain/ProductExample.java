...
public class ProductExample extends BaseExample {
     ...
     * 产品线
     */
    private ProductExample(Builder builder) {
    ...
    public static class Criteria extends GeneratedCriteria {
        ...
        public ProductExample toExample() {
            return this.example;
        }
    ...
    public static final class Builder extends BaseExampleBuilder<Builder, ProductExample> {
        ...
        public ProductExample build() {
            return new ProductExample(this);
        }
    }
}
